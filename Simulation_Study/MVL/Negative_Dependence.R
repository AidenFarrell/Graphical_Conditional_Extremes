...
## Simulate the data
X <- replicate(n = n_sim,
               expr = rmvl(n = n_data, mu = mu_true, Sigma = round(rho_true, 14)),
               simplify = FALSE)
...
## true distribution
X_prob_calc <- rmvl(n = 1e+7, mu = mu_true, Sigma = round(rho_true, 14))
...
# saveRDS(out, file = "Data/MVL_Negative_Dependence_D5.RData")
################################################################################
