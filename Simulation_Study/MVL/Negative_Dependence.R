...
## Simulate the data
X <- replicate(n = n_sim,
               expr = rmvl(n = n_data, mu = mu_true, Sigma = round(rho_true, 13)),
               simplify = FALSE)
...
# Alpha
pdf(file = "Images/Simulation_Study/MVL/Negative_Dependence/Alpha.pdf", width = 15, height = 10)
boxplot_MLEs(
...
# Beta
pdf(file = "Images/Simulation_Study/MVL/Negative_Dependence/Beta.pdf", width = 15, height = 10)
boxplot_MLEs(
  data = lapply(1:d, function(i){do.call(cbind, lapply(1:p, function(j){
...
# Location
pdf(file = "Images/Simulation_Study/MVL/Negative_Dependence/Location.pdf", width = 15, height = 10)
boxplot_MLEs(
  data = lapply(1:d, function(i){do.call(cbind, lapply(1:p, function(j){
...
# Scale (Left)
pdf(file = "Images/Simulation_Study/MVL/Negative_Dependence/Scale_Left.pdf", width = 15, height = 10)
boxplot_MLEs(
  data = lapply(1:d, function(i){do.call(cbind, lapply(1:p, function(j){
...
# Scale (Right)
pdf(file = "Images/Simulation_Study/MVL/Negative_Dependence/Scale_Right.pdf", width = 15, height = 10)
boxplot_MLEs(
  data = lapply(1:d, function(i){do.call(cbind, lapply(1:p, function(j){
...
pdf(file = "Images/Simulation_Study/MVL/Negative_Dependence/Scale_Comp.pdf", width = 15, height = 15)
...
# Shape
pdf(file = "Images/Simulation_Study/MVL/Negative_Dependence/Shape.pdf", width = 15, height = 10)
boxplot_MLEs(
  data = lapply(1:d, function(i){do.call(cbind, lapply(1:p, function(j){
...
## true distribution
X_prob_calc <- rmvl(n = 1e+7, mu = mu_true, Sigma = round(rho_true, 13))
...
q_X <- 0.95
u_X <- sapply(mu_true, function(x){qlaplace(p = q_X, location = x)})
...
for(i in 1:d){
  for(j in 1:length(uncon[[1]])){
    ...
    pdf(paste0("Images/Simulation_Study/MVL/Negative_Dependence/Probabilities/Site_", i, "/Prob_", j, ".pdf"), height = 10, width = 10)
