...
# Alpha
pdf(file = "Images/Simulation_Study/MVN/Negative_Dependence/Alpha.pdf", width = 15, height = 10)
boxplot_MLEs(
...
# Beta
pdf(file = "Images/Simulation_Study/MVN/Negative_Dependence/Beta.pdf", width = 15, height = 10)
boxplot_MLEs(
  data = lapply(1:d, function(i){do.call(cbind, lapply(1:p, function(j){
...
# Location
pdf(file = "Images/Simulation_Study/MVN/Negative_Dependence/Location.pdf", width = 15, height = 10)
boxplot_MLEs(
  data = lapply(1:d, function(i){do.call(cbind, lapply(1:p, function(j){
...
# Scale (Left)
pdf(file = "Images/Simulation_Study/MVN/Negative_Dependence/Scale_Left.pdf", width = 15, height = 10)
boxplot_MLEs(
  data = lapply(1:d, function(i){do.call(cbind, lapply(1:p, function(j){
...
# Scale (Right)
pdf(file = "Images/Simulation_Study/MVN/Negative_Dependence/Scale_Right.pdf", width = 15, height = 10)
boxplot_MLEs(
  data = lapply(1:d, function(i){do.call(cbind, lapply(1:p, function(j){
...
pdf(file = "Images/Simulation_Study/MVN/Negative_Dependence/Scale_Comp.pdf", width = 15, height = 15)
...
# Shape
pdf(file = "Images/Simulation_Study/MVN/Negative_Dependence/Shape.pdf", width = 15, height = 10)
boxplot_MLEs(
  data = lapply(1:d, function(i){do.call(cbind, lapply(1:p, function(j){
...
pdf(file = "Images/Simulation_Study/MVN/Negative_Dependence/Gamma_Bias.pdf", width = 15, height = 10)
...
pdf(file = "Images/Simulation_Study/MVN/Negative_Dependence/Gamma.pdf", width = 15, height = 10)
...
for(i in 1:d){
  for(j in 1:length(uncon[[1]])){
    ...
    pdf(paste0("Images/Simulation_Study/MVN/Negative_Dependence/Probabilities/Site_", i, "/Prob_", j, ".pdf"), height = 10, width = 10)
...
u_dep <- lapply(mu_true, function(x){qnorm(p, x)})
...
# Create the ggplot
pdf(file = "Images/Simulation_Study/MVN/Negative_Dependence/Probabilities/MVN_Cond_CDF_Curves.pdf", width = 15, height = 15)
ggplot() +
