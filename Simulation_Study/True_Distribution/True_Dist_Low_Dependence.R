...
round(rbind(alpha_true, beta_true, loc_true, scale_1_true, scale_2_true, shape_true), 3) %>%
...
pdf("Images/Simulation_Study/True_Distribution/Low_Dependence/Alpha.pdf", width = 15, height = 10)
print(Alpha_plot)
dev.off()
...
pdf("Images/Simulation_Study/True_Distribution/Low_Dependence/Beta.pdf", width = 15, height = 10)
print(Beta_plot)
dev.off()
...
pdf("Images/Simulation_Study/True_Distribution/Low_Dependence/Gamma.pdf", width = 20, height = 15)
print(Gamma_plot)
dev.off()
